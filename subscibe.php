...
<html>
<head>
	<title>Stripe Subsciption Payment API Integration</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="container">
		<h1>Stripe Subscription Payment API Integration</h1>
		<div class="panel">
			<form action="payment.php" method="POST" id="paymentFrm">
				<div class="panel-heading">
					<h3 class="panel-title">Plan Subcription with Stripe</h3>
